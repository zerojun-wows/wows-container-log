...
from PySide6.QtWidgets import QHBoxLayout, QHeaderView, QLabel, QPushButton, QSplitter, QTableView, QVBoxLayout, QWidget
...
class GroupEditorPanel(QWidget):
    ...
    def _build_reward_groups_table_view_rows(self, group_list: List[RewardGroup]) -> None:
        ...
        for reward_group in group_list:
            ...
            row = [
                QStandardItem(reward_group.name),
                QStandardItem(reward_group.id)
            ]
